  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: '0 2px 0px 1px #484848 inset, 0 -2px 0px 1px #000000 inset, 0 32px 80px rgba(0,0,0,0.55), 0 8px 20px rgba(0,0,0,0.35)',
        padding: `${bezel}px ${bezel}px ${bezel + 20}px`, boxSizing: 'border-box', flexShrink: 0,
      }}
    >
      ...
      <div style={{ position: 'absolute', right: -3, top: 95, width: 4, height: 36, borderRadius: '0 3px 3px 0', background: 'linear-gradient(180deg, #2E2E2E, #1A1A1A)', boxShadow: '2px 0 3px rgba(0,0,0,0.4)' }} />
      {[62, 108].map((top, i) => (
        <div key={i} style={{ position: 'absolute', left: -3, top, width: 4, height: 28, borderRadius: '3px 0 0 3px', background: 'linear-gradient(180deg, #2E2E2E, #1A1A1A)', boxShadow: '-2px 0 3px rgba(0,0,0,0.4)' }} />
      ))}
    </div>
  );
}
