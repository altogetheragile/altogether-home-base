  ...
  return (
    <>
      ...
      <section style={{ fontFamily: "'DM Sans', system-ui, sans-serif", background: p.white, padding: '96px 0 80px', overflow: 'hidden' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 48px' }} className="aa-about-grid">
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{ marginTop: 28, background: p.deepTeal, borderRadius: 20, padding: '28px 32px', position: 'relative', zIndex: 1 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                {credentials.map((c, i) => (
                  <div key={i} className="aa-cred-item" style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div style={{ paddingTop: 40 }}>
            ...
            <div style={{ borderLeft: `3px solid ${p.orange}`, paddingLeft: 20, marginBottom: 44 }}>
              <p style={{ color: p.midTeal, fontSize: 15, lineHeight: 1.7, fontStyle: 'italic', margin: 0 }}>
                &ldquo;Good agile training should be grounded in real experience - not slides recycled from a manual.&rdquo;
              </p>
            </div>
