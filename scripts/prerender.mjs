...
// Mirrors EXAM_FAQS in src/pages/Exams.tsx. Keep the two in sync.
const EXAM_FAQS = [
  ...
  { q: 'How many questions are in the AgilePM Foundation exam?', a: 'Our AgilePM3 Foundation practice papers contain 50 questions to answer in 40 minutes, with a pass mark of 30 out of 50. They follow the multiple-choice format of the Foundation paper and are based on the latest version of the AgilePM Handbook.' },
