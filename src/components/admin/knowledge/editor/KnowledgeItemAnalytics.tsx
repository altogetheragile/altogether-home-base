  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Content Completeness</CardTitle>
            <CardDescription>
              Analysis of content richness and completeness
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Badge variant={knowledgeItem.name && knowledgeItem.description ? 'default' : 'secondary'}>
                  {knowledgeItem.name && knowledgeItem.description ? 'Complete' : 'Incomplete'}
                </Badge>
              </div>
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm">Background Content</span>
                <Badge variant={knowledgeItem.background ? 'default' : 'secondary'}>
                  {knowledgeItem.background ? 'Has Content' : 'Missing'}
                </Badge>
              </div>
              
              <div className="flex items-center justify-between">
                <span className="text-sm">Use Cases</span>
                <Badge variant={useCasesCount > 0 ? 'default' : 'secondary'}>
                  {useCasesCount > 0 ? `${useCasesCount} Cases` : 'No Cases'}
                </Badge>
              </div>
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Use Cases Breakdown</CardTitle>
            <CardDescription>
              Distribution of use case types
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">Generic Use Cases</span>
                </div>
                <Badge variant="outline">{genericUseCasesCount}</Badge>
              </div>
              
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                  <span className="text-sm">Example Use Cases</span>
                </div>
                <Badge variant="outline">{exampleUseCasesCount}</Badge>
              </div>
              
              <div className="pt-2 border-t border-border">
                <div className="flex items-center justify-between font-medium">
                  <span className="text-sm">Total Use Cases</span>
                  <Badge>{useCasesCount}</Badge>
                </div>
              </div>
            </div>
          </CardContent>
