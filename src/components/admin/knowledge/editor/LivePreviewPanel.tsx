    ...
    <div className={cn("sticky top-32 h-fit", className)}>
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          {/* Metadata */}
          {(formValues.author || formValues.source || formValues.publication_year) && (
            <div className="space-y-2">
              ...
              <div className="space-y-1">
                ...
                {formValues.publication_year && (
                  <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    ...
                    <span>{formValues.publication_year}</span>
                  </div>
                )}
                {formValues.reference_url && (
                  <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    <Link className="h-4 w-4" />
                    <a 
                      href={formValues.reference_url} 
                      target="_blank" 
