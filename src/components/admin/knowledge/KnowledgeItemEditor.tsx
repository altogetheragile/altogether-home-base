...
// The navigation and layout helpers live one directory up from this file.  Adjust
// the relative import paths accordingly to avoid Vite’s ‘failed to resolve
// import’ errors when building.  Without this change, Vite looks for
// FocusBar.tsx, EditorToolbar.tsx and VerticalStepper.tsx inside this
// ‘knowledge’ folder instead of the parent ‘admin’ folder.
 ...
 */
// Export the improved Knowledge Item editor.  We export it both as the default
// export and as a named export (`KnowledgeItemEditor`) so that other parts of
// the codebase can import it either way.  This helps avoid missing export
// errors in files that expect a named `KnowledgeItemEditor` component.
      ...
      <FormProvider {...methods}>
        <form onSubmit={methods.handleSubmit(handleSubmit)}>
          ...
          <div style={{ display: 'flex', minHeight: 'calc(100vh - 48px)' }}>
            ...
            <VerticalStepper
              // Pass just the step labels into the stepper.  The VerticalStepper
              // component expects an array of strings and an onStepClick handler.
...
// Provide a named export for convenience.  Some modules import { KnowledgeItemEditor } from this file.
export { KnowledgeItemEditor };
