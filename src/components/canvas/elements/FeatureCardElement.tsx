...
export const FeatureCardElement: React.FC<FeatureCardElementProps> = ({
  ...
  return (
    ...
    >
      ...
      <div 
        className={`h-full bg-card border-2 border-l-4 border-l-blue-500 rounded-lg p-3 transition-all flex flex-col ${
          isCompact ? 'min-h-0' : 'min-h-[160px]'
        } ${
          isSelected && !isMarqueeSelecting
            ? 'border-primary border-l-blue-500 shadow-lg shadow-primary/20' 
