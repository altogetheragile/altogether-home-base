    ...
    <div className="flex h-full flex-col">
      ...
      <div className="min-h-0 flex-1 overflow-hidden xl:flex">
        ...
        <div className={cn('h-full overflow-y-auto px-2 py-3 sm:px-3',
          ...
          <ParkView state={state} large onPlaceItem={onPlaceItem} onSetPathStyle={onSetPathStyle} onAddConnector={onAddConnector} onUpdateConnector={onUpdateConnector} onDeleteConnector={onDeleteConnector} deployMode={deployMode} deployStyle={deployStyle} onFinishDeploy={onFinishDeploy} onImprove={onImprove} onSetSpot={onSetSpot} onSetSize={onSetSize} onNest={onNest} onUnnest={onUnnest} onRename={onRename} />
        </div>
      </div>
    </div>
  );
