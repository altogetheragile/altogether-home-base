...
function step(state: ZooGameState, action: ZooAction): ZooGameState {
  switch (action.type) {
    ...
    case 'ADOPT':
      return adopt(state, action.key);
    case 'OPEN_GROUND':
      return openGround(state, action.zone);
    case 'ESTIMATE_ITEM':
    ...
    case 'FINISH_ITEM':
      return finishItem(state, action.id, action.by);
    case 'MOVE_INSIDE':
      return moveInside(state, action.id, action.kind, action.index, action.spot);
    case 'ADD_INSIDE':
      return addInside(state, action.id, action.kind);
    ...
    case 'SEND_BACK':
      return sendItemBack(state, action.id, action.by);
    case 'ANSWER_QUESTION':
      return answerQuestion(state, action.id, action.choice, action.by);
    case 'ASK_TO_CHECK':
      return askToCheck(state, action.id, action.by);
    case 'SET_SPRINT_BET':
    ...
    case 'SET_CLOCK_PAUSED':
      return setClockPaused(state, action.paused);
    case 'TICK_SCRUM':
