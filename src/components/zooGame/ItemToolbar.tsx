    ...
    <div className={cn('flex flex-wrap items-center gap-0.5',
      ...
      {item.category === 'amenity' && (
        <>
          ...
          <Divider />
          {/* Every building is drawn from the colours chosen here, so every one of them is offered
              again. Four kinds used to arrive as photographs and could not be repainted, and the
              controls were hidden to stop the studio promising what it could not do. */}
