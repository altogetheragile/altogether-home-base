...
export function PbiEditor({ zones, state, item, enclosures = [], useStories, onToggleStories, onSave, onEstimate, onCancel }: PbiEditorProps) {
  ...
  return (
    <div className="space-y-3 rounded-lg border border-primary/40 bg-primary/5 p-4">
      ...
      {editing && onEstimate && (
        <div className="space-y-1">
          <span className="text-[11px] font-semibold uppercase tracking-wide text-muted-foreground">Story points <span className="font-normal normal-case">- a common way to size work; Scrum doesn&rsquo;t mandate it</span></span>
          <div className="flex flex-wrap gap-1.5">
