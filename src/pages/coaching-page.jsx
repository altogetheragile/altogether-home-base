...
const IllustrationSpot = ({ bg, height = 280 }) => (
  ...
  return (
    <div style={{ fontFamily: "'Segoe UI', system-ui, sans-serif", background: p.white }}>
      ...
      <div style={{ background: p.white, borderBottom: `1px solid ${p.paleTeal}`, position: "sticky", top: 0, zIndex: 100 }}>
        <div style={{ padding: isMobile ? "0 20px" : "0 48px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
          ...
          <div className="aa-nav-links" style={{ gap: 32 }}>
            {navLinks.map(item => (
              <span key={item} style={{ color: item === "Coaching" ? p.orange : p.body, fontWeight: item === "Coaching" ? 700 : 500, fontSize: 13, cursor: "pointer", borderBottom: item === "Coaching" ? `2px solid ${p.orange}` : "none", paddingBottom: 2 }}>{item}</span>
            ))}
          </div>
        ...
        <div className={`aa-mobile-menu${menuOpen ? " open" : ""}`} style={{ flexDirection: "column", background: p.white, borderTop: `1px solid ${p.paleTeal}`, padding: "8px 0 16px" }}>
          {navLinks.map(item => (
            <span key={item} onClick={() => setMenuOpen(false)} style={{ color: item === "Coaching" ? p.orange : p.body, fontSize: 16, fontWeight: item === "Coaching" ? 700 : 500, padding: "14px 20px", cursor: "pointer", borderBottom: `1px solid ${p.paleTeal}` }}>{item}</span>
          ))}
        </div>
      </div>
      ...
      <div style={{ background: "#006666", padding: isMobile ? "48px 20px 40px" : "72px 48px 60px" }}>
        <div style={{ maxWidth: 680 }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 16, alignItems: "center" }}>
            ...
            <span style={{ color: p.lightTeal, fontWeight: 700, fontSize: 14, cursor: "pointer", display: "flex", alignItems: "center", gap: 6 }}>
          ...
          <div className="aa-service-layout" style={{ direction: si % 2 === 1 ? "rtl" : "ltr" }}>
            <div style={{ direction: "ltr" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 24, flexWrap: "wrap" }}>
                ...
                <button style={{ background: p.orange, color: "#fff", border: "none", padding: "13px 24px", borderRadius: 10, fontWeight: 700, fontSize: 14, cursor: "pointer", display: "flex", alignItems: "center", gap: 8 }}>
      ...
      <div className="aa-section-pad" style={{ background: "#006666" }}>
        <SectionHeading label="Why Altogether Agile" title="Coaching grounded in real experience." light={true} />
      ...
      <div className="aa-section-pad" style={{ background: p.white }}>
        ...
        <div className="aa-three-col">
          {testimonials.map((t, i) => (
            <div key={i} style={{ background: p.skyTeal, borderRadius: 14, padding: "24px" }}>
        ...
        <div className="aa-two-col" style={{ alignItems: "center" }}>
          ...
          <div style={{ background: "rgba(255,255,255,0.06)", borderRadius: 16, padding: "32px 28px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              <button style={{ background: p.orange, color: "#fff", border: "none", padding: "14px 20px", borderRadius: 10, fontWeight: 700, fontSize: 15, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
            ...
            <div style={{ background: p.white, borderRadius: 16, padding: isMobile ? "28px 20px" : "40px 40px" }}>
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                <button
                  ...
                  style={{ background: p.orange, color: "#fff", border: "none", padding: "14px 28px", borderRadius: 10, fontWeight: 700, fontSize: 15, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}
                >
