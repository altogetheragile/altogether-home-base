...
export default function ZooGame() {
  ...
  const shellProps = { onPlaceItem: setItemPos, onSetPathStyle: setPathStyle, onSetPathRoute: setPathRoute, onAddPath: addPath, onDeletePath: deletePath, onClearPaths: clearPaths, onSetDod: setDod, onSetProductGoal: setGoal, onSave: requestSave, onOpenSaves: () => setSavesOpen(true), onPoRefine: handlePoRefine, poRefining: isRefining, poNote, onDismissPoNote: () => setPoNote(null) };
