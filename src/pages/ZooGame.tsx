...
export function ZooGameScreens({ game, saves = true, seat = null, observer, covering, mustAgree = [] }:
  { game: ZooGameApi; saves?: boolean; seat?: SeatName | null; observer?: boolean; covering?: SeatName[]; mustAgree?: string[] }) {
