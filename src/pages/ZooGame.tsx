...
export default function ZooGame() {
  const { state, start, setPhase, setGoal, takeSignal, plan, pull, build, editBuild, addAnotherPbi, open, closeDay, holdDailyScrum, skipDailyScrum, nextSprint, reset } = useZooGame();
