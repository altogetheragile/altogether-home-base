...
// Excel column mappings to database fields
const EXCEL_FIELD_MAPPINGS: ImportMappingConfig = {
  ...
  'Duration Min (minutes)': 'duration_min_minutes',
  'Duration Max (minutes)': 'duration_max_minutes',
  'Team Size Min': 'team_size_min',
  'Team Size Max': 'team_size_max',
  'Generic Who': 'generic_who',
  'Generic What': 'generic_what',
  'Generic When': 'generic_when',
  'Generic Where': 'generic_where',
  'Generic Why': 'generic_why',
  'Generic How': 'generic_how',
  'Generic How Much': 'generic_how_much',
  'Generic Summary': 'generic_summary',
  'Example Who': 'example_who',
  'Example What': 'example_what',
  'Example When': 'example_when',
  'Example Where': 'example_where',
  'Example Why': 'example_why',
  'Example How': 'example_how',
  'Example How Much': 'example_how_much',
  'Example Use Case': 'example_use_case',
  'Example Summary': 'example_summary',
  'Industry Context': 'industry_context',
  'Planning Considerations': 'planning_considerations',
  'Focus Description': 'focus_description',
  'Required Skills': 'required_skills',
  'Success Criteria': 'success_criteria',
  'Common Pitfalls': 'common_pitfalls',
  'Related Practices': 'related_practices',
  'Typical Participants': 'typical_participants'
};
