-- Recovered into version control from the applied production database
-- (supabase_migrations.schema_migrations) on 2026-06-01. This migration
-- was applied to the remote DB on 2026-04-29 but had no file in the repo.
