-- Insert the new agile certifications blog post as a draft
...
INSERT INTO public.blog_posts (
  ...
  'Agile Certifications: Do They Actually Matter?',
  'agile-certifications-do-they-matter',
  'There are dozens of agile certifications available. Some genuinely open doors. Others are expensive box-ticking. Here is an honest guide to choosing the right path for where you are in your career.',
  $CONTENT$<style>
...
.decision-table td:first-child { font-weight: 600; color: #1a1a1a; white-space: nowrap; }
...
<p class="bio"><em>Alun Davies-Baker is the founder of AltogetherAgile, a London-based agile training and consultancy practice. He is an assessor for the Agile Business Consortium, holds ICF Associate Certified Coach accreditation, and is a co-author of the AgilePM v3 handbook and AgileBA course modules. He works with teams across pharmaceuticals, finance, education, and the public sector.</em></p>
  ...
  'Agile Certifications: Do They Actually Matter? | AltogetherAgile',
  'There are dozens of agile certifications. Some genuinely open doors. Others are not worth the exam fee. Here is an honest guide to choosing the right path for where you are now.',
  ARRAY['agile certifications','agile training certification','best agile certification','agile learning path','kanban certification','agile professional development'],
  now(),
  now()
);
