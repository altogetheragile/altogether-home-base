-- Fresh Start: Drop existing KB tables and recreate based on Excel structure
...
-- Create RLS policies for Activity Domains
...
-- Create RLS policies for Planning Layers
...
-- Create RLS policies for Knowledge Items
...
-- Create RLS policies for Item Tags
...
-- Insert some default reference data to get started
INSERT INTO public.knowledge_categories (name, slug, description) VALUES
('Scrum Technique', 'scrum-technique', 'Techniques specific to Scrum framework'),
('Agile Practice', 'agile-practice', 'General agile practices and methodologies'),
('Facilitation Method', 'facilitation-method', 'Methods for facilitating meetings and workshops');

INSERT INTO public.activity_domains (name, slug, description) VALUES
('Team Development', 'team-development', 'Activities focused on developing team capabilities'),
('Process Improvement', 'process-improvement', 'Activities for improving processes and workflows'),
('Communication', 'communication', 'Activities for improving communication and collaboration');

INSERT INTO public.planning_layers (name, slug, description, display_order) VALUES
('Strategic', 'strategic', 'Strategic level planning and activities', 1),
('Tactical', 'tactical', 'Tactical level planning and execution', 2),
('Operational', 'operational', 'Day-to-day operational activities', 3);