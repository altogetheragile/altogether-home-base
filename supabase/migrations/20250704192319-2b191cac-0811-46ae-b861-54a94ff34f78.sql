...
ALTER TABLE public.events 
ADD CONSTRAINT IF NOT EXISTS fk_events_event_type_id 
FOREIGN KEY (event_type_id) REFERENCES public.event_types(id);

ALTER TABLE public.events 
ADD CONSTRAINT IF NOT EXISTS fk_events_category_id 
FOREIGN KEY (category_id) REFERENCES public.event_categories(id);

ALTER TABLE public.events 
ADD CONSTRAINT IF NOT EXISTS fk_events_level_id 
FOREIGN KEY (level_id) REFERENCES public.levels(id);

ALTER TABLE public.events 
ADD CONSTRAINT IF NOT EXISTS fk_events_format_id 
FOREIGN KEY (format_id) REFERENCES public.formats(id);

-- Add check constraint for status values
ALTER TABLE public.events 
ADD CONSTRAINT IF NOT EXISTS chk_events_status 
