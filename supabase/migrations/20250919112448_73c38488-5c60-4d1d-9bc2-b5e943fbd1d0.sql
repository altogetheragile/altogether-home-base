...
SET version = CASE 
  WHEN numbered_duplicates.rn = 1 THEN numbered_duplicates.version -- Keep first one as is
  ELSE numbered_duplicates.version || '.' || numbered_duplicates.rn::text -- Add suffix to duplicates
END
