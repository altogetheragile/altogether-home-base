...
-- Phase 2: Migrate data from knowledge_templates to media_assets (using 'document' type for PDFs)
...
SELECT 
  id,
  'document' as type,  -- Using 'document' instead of 'template'
  title,
  ...
  COALESCE(version, '1.0') as template_version,
