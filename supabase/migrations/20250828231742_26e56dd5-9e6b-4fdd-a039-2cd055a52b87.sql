-- Process staging data into proper knowledge tables (using correct constraints)
DO $$
DECLARE
    staging_row record;
    category_id uuid;
    ...
    LOOP
        ...
        IF staging_row.raw_data->>'Category' IS NOT NULL THEN
            ...
            IF category_id IS NULL THEN
                ...
                WHERE slug = lower(regexp_replace(staging_row.raw_data->>'Category', '[^a-zA-Z0-9]+', '-', 'g'));
            END IF;
        END IF;
        ...
        IF staging_row.raw_data->>'Domain' IS NOT NULL THEN
            ...
            IF domain_id IS NULL THEN
                ...
                WHERE slug = lower(regexp_replace(staging_row.raw_data->>'Domain', '[^a-zA-Z0-9]+', '-', 'g'));
            END IF;
        END IF;
        ...
        IF staging_row.raw_data->>'Focus' IS NOT NULL THEN
            ...
            IF focus_id IS NULL THEN
                ...
                WHERE slug = lower(regexp_replace(staging_row.raw_data->>'Focus', '[^a-zA-Z0-9]+', '-', 'g'));
            END IF;
        END IF;
        ...
        IF staging_row.raw_data->>'Planning Layer' IS NOT NULL THEN
            ...
            IF planning_layer_id IS NULL THEN
                ...
                WHERE slug = lower(regexp_replace(staging_row.raw_data->>'Planning Layer', '[^a-zA-Z0-9]+', '-', 'g'));
            END IF;
        END IF;
        ...
        IF staging_row.raw_data->>'Source' IS NOT NULL THEN
            ...
            IF tag_id IS NULL THEN
                ...
                WHERE slug = lower(regexp_replace(staging_row.raw_data->>'Source', '[^a-zA-Z0-9]+', '-', 'g'));
            END IF;
